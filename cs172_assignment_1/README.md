...
DISCLAIMER was unable to implement it independently so it will run for a long time for every test I apologize ahead of time and if code without these code for testing purposed will be provided
